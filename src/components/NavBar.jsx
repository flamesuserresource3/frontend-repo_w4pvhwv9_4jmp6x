...
import { Moon, Sun, User, Upload, Rocket } from 'lucide-react';
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        <a href="#" className="flex items-center gap-2">
          <motion.div
            ...
            className="flex h-8 w-8 items-center justify-center rounded-md bg-gradient-to-tr from-violet-500 to-blue-500 text-white"
          >
            <Rocket size={16} />
          </motion.div>
        ...
        <nav className="hidden items-center gap-6 text-sm text-gray-700 dark:text-gray-200 md:flex">
          <a href="#talent" className="hover:text-violet-500 transition-colors">Hire Talent</a>
          <a href="#hire" className="hover:text-violet-500 transition-colors">How it works</a>
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="inline-flex h-9 w-9 items-center justify-center rounded-md border border-black/10 bg-white text-gray-800 transition hover:-translate-y-0.5 hover:bg-gray-50 dark:border-white/10 dark:bg-white/10 dark:text-white dark:hover:bg-white/20">
            <User size={18} />
          </button>
        </div>
      </div>
